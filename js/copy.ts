...
function createClipboardElement (text: string, type?: 'text' | 'html'): HTMLElement {
...
function copy (text: string, callback?: Function) {
...
function copyHTML (html: string, callback?: Function) {
